...
const ASSETS = [
  ...
  './js/views/approvals.js', './js/views/importer.js', './js/views/settings.js', './js/views/staffbox.js', './js/views/bellsbox.js', './js/views/notice.js', './js/views/membersbox.js', './js/views/memoview.js', './js/views/academic.js', './js/views/trips.js', './js/memo.js', './js/lib/acadparse.js',
